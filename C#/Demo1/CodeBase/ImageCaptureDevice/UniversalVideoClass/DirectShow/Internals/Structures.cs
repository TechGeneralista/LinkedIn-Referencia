...
{
    [ComVisible(false)]
    internal enum PinDirection { Input, Output }
    ...
    internal enum DsEvCode { None, Complete = 0x01, DeviceLost = 0x1F }
    ...
    internal enum FilterState { State_Stopped, State_Paused, State_Running }
}
