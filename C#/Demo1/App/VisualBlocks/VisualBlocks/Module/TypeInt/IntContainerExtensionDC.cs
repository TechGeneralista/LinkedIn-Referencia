...
{
    internal class IntContainerExtensionDC : BlockItemDC, ICanBackupAndRestore
    {
        public BlockItemTriggerInputDC BlockItemTriggerInputDC { get; }
        public BlockItemTriggerOutputDC BlockItemTriggerOutputDC { get; }
        public BlockItemDataInputDC<Container<int?>> BlockItemDataInputDC { get; }
        public BlockItemDataOutputDC<Container<int?>> BlockItemDataOutputDC { get; }


        public IntContainerExtensionDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
            BlockItemDataInputDC = new BlockItemDataInputDC<Container<int?>>(dependencyParams);
