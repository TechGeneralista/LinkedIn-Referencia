...
{
    internal class StringContainerReadDC : BlockItemDC, ICanBackupAndRestore
    {
        ...
        public StringContainerReadDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
