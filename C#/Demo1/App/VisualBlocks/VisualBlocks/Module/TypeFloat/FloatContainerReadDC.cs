...
{
    internal class FloatContainerReadDC : BlockItemDC, ICanBackupAndRestore
    {
        ...
        public FloatContainerReadDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
