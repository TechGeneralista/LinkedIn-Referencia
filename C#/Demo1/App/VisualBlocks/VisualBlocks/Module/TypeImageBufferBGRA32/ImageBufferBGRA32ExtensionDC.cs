...
{
    internal class ImageBufferBGRA32ExtensionDC : BlockItemDC, ICanBackupAndRestore
    {
        public BlockItemTriggerInputDC BlockItemTriggerInputDC { get; }
        public BlockItemTriggerOutputDC BlockItemTriggerOutputDC { get; }
        public BlockItemDataInputDC<ImageBufferBGRA32> BlockItemDataInputDC { get; }
        public BlockItemDataOutputDC<ImageBufferBGRA32> BlockItemDataOutputDC { get; }


        public ImageBufferBGRA32ExtensionDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
            BlockItemDataInputDC = new BlockItemDataInputDC<ImageBufferBGRA32>(dependencyParams);
