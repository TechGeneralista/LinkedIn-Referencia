...
{
    internal class BoolContainerExtensionDC : BlockItemDC, ICanBackupAndRestore
    {
        public BlockItemTriggerInputDC BlockItemTriggerInputDC { get; }
        public BlockItemTriggerOutputDC BlockItemTriggerOutputDC { get; }
        public BlockItemDataInputDC<Container<bool?>> BlockItemDataInputDC { get; }
        public BlockItemDataOutputDC<Container<bool?>> BlockItemDataOutputDC { get; }


        public BoolContainerExtensionDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
            BlockItemDataInputDC = new BlockItemDataInputDC<Container<bool?>>(dependencyParams);
