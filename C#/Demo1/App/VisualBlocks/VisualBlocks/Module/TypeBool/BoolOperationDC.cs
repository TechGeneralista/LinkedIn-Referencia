...
{
    internal class BoolOperationDC : BlockItemDC, ICanBackupAndRestore
    {
        public BlockItemTriggerInputDC BlockItemTriggerInputDC { get; }
        public BlockItemTriggerOutputDC BlockItemTriggerOutputDC { get; }
        public BlockItemDataInputDC<bool?> BlockItemDataInputDC_A { get; }
        public BlockItemDataInputDC<bool?> BlockItemDataInputDC_B { get; }
        ...
        public BoolOperationDC(DependencyParams dependencyParams) : base(dependencyParams)
        {
            BlockItemDataInputDC_A = new BlockItemDataInputDC<bool?>(dependencyParams);
            BlockItemDataInputDC_B = new BlockItemDataInputDC<bool?>(dependencyParams);
        ...
        {
            bool? value_A = BlockItemDataInputDC_A.Value;
            bool? value_B = BlockItemDataInputDC_B.Value;
