...
namespace ImageProcess.Templates
{
    public class FormatConvert
    {
        ...
        public void ConvertBGR24ToBGRA32(int width, int height, int stride, DataBuffer<byte> sourceBuffer)
        {
        ...
        public void ConvertBGR32ToBGRA32(WriteableBitmap source, DataBuffer<byte> sourceBuffer)
        {
