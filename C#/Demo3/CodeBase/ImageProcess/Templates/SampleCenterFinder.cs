...
{
    public class SampleCenterFinder : IDisposable
    {
        ...
        public SampleCenterFinder(OpenCLAccelerator openCLAccelerator, TransformedUserContourPath transformedUserContourPath)
        {
            this.openCLAccelerator = openCLAccelerator;
            Angle = transformedUserContourPath.Angle;
            SamplingPointPair[] pointPairs = transformedUserContourPath.SamplingPointPairs;
        ...
        public void FindCenters(Image2DBuffer imageBuffer, byte sensitivity, byte match)
        {
