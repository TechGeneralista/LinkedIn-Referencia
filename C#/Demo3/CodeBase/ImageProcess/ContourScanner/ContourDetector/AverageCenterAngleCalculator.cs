...
{
    public class AverageCenterAngleCalculator : AverageCenterCalculator
    {
        ...
        internal void CalculateRelativeCenter(Point center) => RelativeCenter = (Point)Point.Subtract(AbsoluteCenter, center);
