...
namespace ImageProcessLib.OpenCL.Compute
{
    ...
    public class ComputeBuffer<T> : ComputeBufferBase<T> where T : struct
    {
        ...
        /// <remarks> Note, that <paramref name="data"/> cannot be an "immediate" parameter, i.e.: <c>new T[100]</c>, because it could be quickly collected by the GC causing ImageProcessLib.OpenCL to send and invalid reference to OpenCL. </remarks>
